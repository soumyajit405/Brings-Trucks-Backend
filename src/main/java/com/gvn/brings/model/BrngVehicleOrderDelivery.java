 ...
 */
@Entity
@Table(name="brng_vehicle_order_delivery")
@NamedQuery(name="BrngVehicleOrderDelivery.findAll", query="SELECT b FROM BrngVehicleOrderDelivery b")
public class BrngVehicleOrderDelivery extends AbstractBaseModel  {
	...
	public BrngVehicleOrderDelivery() {
	}
